                    ...
                    <div >
                        <div className="content" >
                            <Switch>
                                ...
                                {LoggedInUser.role === 'admin' && <React.Fragment> <Route path='/emp-dashboard' render={() => (<EmployeeDashboard employeeList={employeeList} updateEmployeeList={this.updateEmployeeList} />)} />
