...
class EmployeeDashboard extends React.Component {
    ...
    render() {
        const {loggendInUserName, employeeList} = this.props;
            ...
            <React.Fragment>
                ...
                <PopOverModal show={showAddUserModal} handleClose={e => this.modalClose(e)} >
                    ...
                    <div className="form-group">
                        ...
                        <div className="modal-field">
                            <button onClick={e => this.addUpdateUser(e)} type="button" className="btn btn-primary" disabled={!this.enableAddEmpButton}>{isEditMode ? <span>Update</span> : <span>Add</span> } employee</button>
                        </div>
                    </div>
                </PopOverModal>
